...
{
    self.scrollView.frame=CGRectMake(0, 0, frame.size.width, frame.size.height-self.pageControl.frame.size.height);
    self.pageControl.frame=CGRectMake(0, frame.size.height-self.pageControl.frame.size.height, self.pageControl .frame.size.width, self.pageControl.frame.size.height);
...
- (void)setup
{
    ...
    CGRect scrollViewFrame = CGRectMake(0.0, 0.0, self.frame.size.width, self.frame.size.height - 10.0);
...
//    self.scrollView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
    ...
    CGRect pageControlFrame = CGRectMake(0.0, self.frame.size.height-10, self.frame.size.width, 10.0);
    self.pageControl = [[[UIPageControl alloc] initWithFrame:pageControlFrame] autorelease];
    self.pageControl.numberOfPages = 2;
    self.pageControl.backgroundColor = [UIColor clearColor];
    self.pageControl.currentPage = 0;
    self.pageControl.hidden = NO;
    self.pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:89.0f/255.0f green:105.0f/255.0f blue:108.0f/255.0f alpha:1];
    self.pageControl.pageIndicatorTintColor = [UIColor colorWithRed:177.0f/255.0f green:187.0f/255.0f blue:192.0f/255.0f alpha:1];
